...
qx.Class.define("qooxdo_proj.Application",
  {
    ...
    members:
    {
      ...
      main() {
        ...
        this._loginPage.addListener("loginSuccess", (e: any) => {
      ...
      _initializeMainApplication() {
        ...
        counterButtons.addListener("pressMe", (e: any) => {
          const data = e.getData();
        ...
        (this as any)._buttonContainer = mainContainer;
      },

      _handleLoginSuccess(username: string) {
        // Hide login page
      ...
      _handleSubmit() {
        ...
        const studentData = {
          ...
          dateOfBirth: personalData.dateOfBirth ? (personalData.dateOfBirth as Date).toISOString() : null,
